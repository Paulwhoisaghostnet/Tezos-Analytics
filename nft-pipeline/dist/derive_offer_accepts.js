...
exports.deriveOfferAccepts = deriveOfferAccepts;
 ...
 */
function deriveOfferAccepts(config, storage) {
    ...
    for (const tx of rawTxs) {
        ...
        if (!creatorSeller.startsWith('tz'))
            continue;
        ...
        const referenceListPrice = storage.getLatestListingPrice(creatorSeller, tokenContract, tokenId, tx.timestamp);
...
//# sourceMappingURL=derive_offer_accepts.js.map