...
exports.deriveDailyMetrics = deriveDailyMetrics;
exports.calculateVolumeTrend = calculateVolumeTrend;
/**
 ...
 */
function deriveDailyMetrics(storage) {
 ...
 */
function calculateVolumeTrend(storage) {
    const allMetrics = storage.getAllDailyMetrics();
    if (allMetrics.length < 2) {
...
//# sourceMappingURL=derive_daily_metrics.js.map